...
Synthesizer.init = function () {
  ...
  if (window.DeviceOrientationEvent) {
    ...
    window.addEventListener('deviceorientation', 
      function (e) { Synthesizer.orientation(e)}, false);
    } else {
...
Synthesizer.orientation = function (eventData) {
...
Sound.prototype.play = function (freq, time) {
  ...
  if (Synthesizer.oscMessage) {
    Synthesizer.client.send("/note", [this.freq, this.volume, Synthesizer.xset, Synthesizer.yset, Synthesizer.zset]);
  }
...
Sound.prototype.gate = function () {
    ...
    if (this.sustainTime) {// sustain - 
      ...
      this.wave.stop(time + this.attack+this.decay+this.sustainTime+this.release);
      this.sustainTime = false; 
      this.active = false;
      // if (Synthesizer.oscMessage) {
